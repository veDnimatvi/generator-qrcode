...
const CRC_ID = "63";
const CRC_LENGTH = "04";
const ATM_CARD_NUMBER_PREFIX = "9704";
...
function isBankCard(receiverNumber = "") {
  return (
    receiverNumber.startsWith(ATM_CARD_NUMBER_PREFIX) &&
    (receiverNumber.length === 16 || receiverNumber.length === 19)
  );
}

function buildQRProps({
  qrType,
  bin,
  receiverNumber,
  instrumentType,
  ...
  const qrProperties = {
    ...
    merchantAccountInformation: {
      ...
      value: {
        ...
        servicesCode: {
          id: "02",
          value: isBankCard(receiverNumber)
